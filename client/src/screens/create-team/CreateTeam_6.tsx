...
type CreateTeamProps = StackScreenProps<RootStackParamList, 'CreateTeam_6'>;

export default function CreateTeam_6({ route }: CreateTeamProps) {
  ...
  return isLoading ? (
    ...
    <>
      ...
      <SkipButton text="다음에 초대할게요" onPress={() => navigation.navigate('CreateTeam_7')} />
    </>
  );
}
