...
export const imagesToLoad = [
  ...
  require('./images/lending_1.png'),
  require('./images/lending_2.png'),
  require('./images/lending_3.png'),
  require('./images/lending_4.png'),
  require('./images/lending_5.png'),
  require('./images/lending_6.png'),
  require('./images/lending_7.png'),
  require('./images/lending_8.png'),
];
